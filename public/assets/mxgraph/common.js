...
var Model__currentAccessPointID = 0;
var Model__CONTAINER_BASENAME = "element_";
var Model__NETWORK_BASENAME = "network_";
var Model__ACCESSPOINT_BASENAME = "access_point_";
...
var Graph__NetworkAccessPointLabel = {
  type : NETWORK_ELEMENT_TYPE,
  contentHTML : '<h5 id="toptitle" class="no-selection" style="margin:0px;">'+NETWORK_ELEMENT_TYPE+'</h5><br>'+
  '<img src="assets/docker_image_icons/access_point.png" width="48" height="48"><br><h7 id=element_info></h7>'
};
...
function Graph__AccessPointCreate(graph, obj, x, y) {
  Graph__log("Graph__AccessPointCreate")
  var parent = graph.getDefaultParent();
  var model = graph.getModel();
  var v1 = null;
  var label = Graph__NetworkAccessPointLabel;
